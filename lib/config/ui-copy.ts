...
export const UI_COPY = {
  ...
  tratativaValidacaoHint:
    "O técnico solicitou validação a você (acionador). Registre o resultado para",
  tratativaValidacaoOutcome: "Resultado",
  tratativaValidacaoNote: "Observações",
  tratativaValidacaoNotePlaceholder: "Ex.: cliente confirmou normalização do sinal",
